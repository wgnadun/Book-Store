...
import regImg from '../assets/reg.jpg'; // Reusing the same image from login page
...
const Register = () => {
  ...
  // Generate falling elements on component mount (same animation effect as login page)
  useEffect(() => {
    const elements = [];
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
      {/* Left side with form - now stacks on top on mobile */}
      <div className="w-full lg:w-1/2 bg-gradient-to-br from-gray-800 to-gray-900 flex justify-center items-center p-4 sm:p-6 lg:p-8 z-10 relative order-2 lg:order-1 flex-1 min-h-0">
        ...
        <div className="w-full max-w-md p-3 sm:p-4 lg:p-8 space-y-3 sm:space-y-4 lg:space-y-6 bg-gradient-to-br from-gray-900/90 to-gray-950/90 rounded-xl shadow-xl border border-gray-800/50 backdrop-blur-sm 
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 text-sm">Join the ReadMore community</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4 lg:space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-gray-200 text-sm font-medium" htmlFor="confirmPassword">
                  Confirm Password
                </label>
              </div>
              <div className="relative">
      ...
      {/* Right side with image and brand text - now on top on mobile */}
      <div className="w-full lg:w-1/2 bg-white relative z-10 overflow-hidden group order-1 lg:order-2 h-[30vh] sm:h-[35vh] md:h-[40vh] lg:min-h-screen flex-shrink-0">
        ...
        <div className="w-full h-full flex items-center justify-center relative">
          ...
          {/* BOOKMART text in top left corner with responsive sizing */}
          <div className="absolute top-3 sm:top-4 lg:top-6 left-3 sm:left-4 lg:left-6 z-20 animate-float">
            <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-blue-950 tracking-wider lg:tracking-widest drop-shadow-lg font-sans">
              BOOK<span className="text-white">MART</span>
            </h1>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-24 sm:h-32 lg:h-40 bg-gradient-to-t from-black/70 to-transparent transition-all duration-500 
            ...
            {/* "Join Our Community" text visible before hover - responsive */}
            ...
            <div className="hidden sm:block absolute top-8 sm:top-12 lg:top-16 left-0 right-0 opacity-0 transition-all duration-500 transform translate-y-8 group-hover:opacity-100 group-hover:translate-y-0 px-4 sm:px-6 lg:px-10 text-center">
              <h2 className="text-lg sm:text-2xl lg:text-4xl font-bold text-white mb-2 lg:mb-4">Create Your ReadMore Account</h2>
              <p className="font-sans font-extralight text-gray-200 leading-tight text-xs sm:text-sm lg:text-base hidden lg:block">
                Join our community of book lovers and gain access to thousands of titles at your fingertips. As a registered member, you'll enjoy personalized recommendations, track your reading history, save your favorite books, and receive special offers tailored just for you. Your reading journey begins with a simple registration.
              </p>
              <p className="font-sans font-extralight text-gray-200 leading-tight text-xs sm:text-sm block lg:hidden">
                Join our community of book lovers and start your reading journey with personalized recommendations and exclusive offers.
              </p>
              <p className="text-sm sm:text-base lg:text-lg text-blue-300 mt-2 sm:mt-3 lg:mt-5">
                Become a member today and start your reading adventure!
              </p>
            </div>
          </div>
        </div>
